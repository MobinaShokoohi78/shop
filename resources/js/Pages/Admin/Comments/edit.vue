            ...
            <div class="rounded shadow-lg p-3 m-3 px-6 pb-6">
                ...
                <div class="p-7 relative overflow-x-auto shadow-md sm:rounded-lg mt-6">
                    ...
                    <form>
                        ...
                        <button type="submit" @click="submit" class="text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-200 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center" >ثبت</button>
...
export default {
        ...
        submit(event){
            ...
            this.form.put('/admin/users/'+ this.user.id,{
                ...
                onSuccess: (data) => {
                    ...
                    this.form.is_admin = data.props.user.is_admin == 1 ? true : false ;
    ...
    mounted() {
        ...
        this.form.is_admin = this.user.is_admin == 1 ? true : false ;
    }
}
</script>
